...
# DBName='sharkconservation_db'
# DBUser='admin'
# DBPassword='Sharks#123'
...
# sed -i "s/'sharkconservation_db'/'$DBName'/g" wp-config.php 
# sed -i "s/'admin'/'$DBUser'/g" wp-config.php 
# sed -i "s/'Sharks#123'/'$DBPassword'/g" wp-config.php
# # Grant permissions
...
cd /var/www/html
sudo aws s3 sync s3://sharkconservation/ .
